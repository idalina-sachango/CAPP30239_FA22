...
Promise.all([
  ...
  counties = topojson.feature(us, us.objects.counties); // for each data year, run create chart, 
...
function createChart(allData, year, elemId) { // wrap data once in  function
